    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!BLLUsuario.ValidarContraseña(txtContraseña.Text))
                {
                ...
                else
                {
                        ...
                        (ds3.Tables[0].Rows[1][1].ToString() == ds2.Tables["dt_productos"].Rows[0][0].ToString()))
                    {
                        ...
                        if (BLLUsuario.CompararContraseñas(txtUsuario.Text, encriptado)) //si las contraseñas son iguales
                        {
                            LBLError.Visible = true;
                            _bitacora.RegistrarBitacora(DateTime.Now.ToString("yyyy-MM-dd"), BEUsuario.Usuario, "Logueo de usuario", "Módulo Login");
